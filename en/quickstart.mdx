...
<Tip>
  Every new account gets a welcome credit bonus, plus free daily credits that reset at 00:00 UTC. Daily credits cover the **Basic** models — currently **Z Image Turbo**, **Flux 2 Klein**, and **Agnes Image 2.1 Flash** for images, plus **Agnes Video 2.0** for video. Premium models like GPT Image 2, Nanobanana Pro, Seedream, Midjourney, Grok Imagine, Seedance, and Veo require welcome/purchased credits.
</Tip>
