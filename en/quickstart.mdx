...
**Choose your model** — select from a range of image models (including GPT Image 2.5 when available) and video models, each with different strengths. Seedance 2.5 supports 4–30 second videos at 480p or 720p with generated audio. Pick an aspect ratio, resolution, and duration; the exact credit cost appears on the generate button before you submit.
