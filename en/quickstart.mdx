---
title: "Quick Start"
description: "Create your first image or video, explore prompts, and connect through the API or MCP."
---
...
**Choose your model** — select from a range of image models (including GPT Image 2.5 when available) and video models, each with different strengths. Seedance 2.5 supports 4–30 second videos at 480p, 720p or 1080p with generated audio — the soundtrack the model creates for you. That is separate from **reference audio**, your own WAV or MP3 clips attached as input to steer the result on Seedance 2.5 and 2.0; reference audio never costs credits. Pick an aspect ratio, resolution, and duration; the exact credit cost appears on the generate button before you submit.
...
GPT Image 2.5 offers five quality levels and a choice of Sunburst (quality priority) or Flare (speed priority), at the same price. Check [List Models](/en/api-reference/endpoint/models) for availability and the current default; see [model pricing](/en/features/models) for credit costs.

## Free Credits

<Tip>
  Every new account gets a welcome credit bonus, plus free daily credits that reset at 00:00 UTC. Daily credits cover the **Basic** models — currently **Flux 2 Klein** and **Agnes Image 2.5 Flash** for images; no video model is on the basic tier at the moment (Agnes Video 2.5 Flash has been temporarily unavailable since 2026-09-22). Premium models like GPT Image 2.5 and GPT Image 2, Nanobanana Pro, Seedream, Midjourney, Grok Imagine, Seedance, and Veo require welcome/purchased credits.
</Tip>
