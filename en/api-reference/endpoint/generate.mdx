...
<ParamField body="modelId" type="string">
  ...
  Image models: `gpt-image-2`, `gemini-3-pro-image-preview`, `nanobanana-2`, `seedream-5.0-lite`, `seedream-4.5`, `midjourney-v7`, `midjourney-niji7`, `z-image-turbo`
...
<ParamField body="resolution" type="string">
  ...
  Available values depend on the model: image models support `1K` / `2K` / `3K` / `4K`; video models support `480p` / `720p`. See [Models](/en/features/models) for each model's supported resolutions and defaults.
</ParamField>
