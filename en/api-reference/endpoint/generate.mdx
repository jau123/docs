...
<ParamField body="modelId" type="string">
  ...
  Image models: `gpt-image-2`, `gemini-3-pro-image-preview`, `nanobanana-2`, `seedream-5.0-lite`, `seedream-4.5`, `midjourney-v8.1`, `flux2-klein`, `z-image-turbo`
...
<ParamField body="referenceVideo" type="string">
  ...
  When this field is present, billing uses the "with reference video" tier (Fast 480p 8, 720p 14 credits/sec; Pro 720p 16, 1080p 28 credits/sec), with the minimum-billable-seconds floor applied (see [Models](/en/features/models)).
</ParamField>
