...
<ParamField body="resolution" type="string" default="2K">
  ...
  Available values depend on the model: image models support `2K` / `3K` / `4K`; video models support `480p` / `720p`. See [Models](/en/features/models) for each model's supported resolutions.
</ParamField>
