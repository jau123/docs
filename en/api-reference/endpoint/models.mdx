...
<ResponseField name="extra_config" type="object">
  ...
  | `pricingPerSec` | Seedance 2.5 / Seedance 2.0 / Grok Video 1.5 / Agnes Video 2.0 | Per-second direct-generation rate, keyed by resolution — or by tier then resolution on models that expose tiers |
