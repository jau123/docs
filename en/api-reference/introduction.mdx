...
| `invalid_reference_video` | 400 | The reference video couldn't be read, or its duration is out of range — it must be 2–15 seconds, at most 50MB, and a URL hosted on the platform |
