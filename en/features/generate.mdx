...
| Midjourney V7 / Niji 7 | ~50–77 seconds |
...
> The "Images per request" limit applies to the Web UI only. Each API call always returns 1 image (Midjourney V7 / Niji 7 always return 4 candidates per call).
