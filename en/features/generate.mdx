...
| --- | --- | --- | --- |
| **Stylize** | 0–1000 | 0 | Controls how strongly Midjourney's aesthetic is applied. Lower = more literal, higher = more artistic. |
...
Extension rates are lower (480p 8 credits/sec, 720p 14 credits/sec, 1080p 14 credits/sec), but **billed seconds include the reference video's duration** (never below the minimum-billable floor). The full formula, lookup table, and examples are in [Models → Seedance 2.0](/en/features/models).

Typical costs:
- Extend by 5 sec on a 3-second video: **72 credits** (480p)
- Extend by 10 sec on a 5-second video: **238 credits** (720p)
