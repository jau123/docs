...
description: "Generate images & videos on MeiGen with GPT Image 2, Nano Banana 2, Seedream 5.0 Lite, Midjourney Niji 7, Seedance 2.0, Veo 3.1 & more. Prompt editor with variables, color picker, and @ mentions."
---
...
| Midjourney Niji 7 | ~77 seconds |
| Happyhorse 1.0 (video) | ~1–2 minutes |
| Seedance 2.0 Fast (video) | ~1–3 minutes (varies by duration / resolution) |
| Seedance 2.0 Pro (video) | ~2–4 minutes (slower, native 1080p) |
...
> The "Images per request" limit applies to the Web UI only. Each API call always returns 1 image (Midjourney V8.1 / Niji 7 always return 4 candidates per call).
