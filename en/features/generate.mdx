...
Extension uses a separate With-reference-video rate table (480p 8 credits/sec, 720p 14 credits/sec, 1080p 14 credits/sec). **Billable seconds = reference video duration + your selected duration** (not less than the minimum-billable floor). The full formula, lookup table, and examples are in [Models → Seedance 2.0](/en/features/models).
...
| Seedance 2.0 (video) | ~1–3 min (Fast tier) / ~2–4 min (Pro tier) |
