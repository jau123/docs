...
description: "Install MeiGen MCP plugin for Claude Code, Cursor, Windsurf, or OpenClaw in minutes. Generate with GPT Image 2, Nano Banana 2, Midjourney, Seedream and more. Open-source plugin, credit-based generation."
---
...
The easiest way to get started. Access multiple AI models (GPT Image 2, Nanobanana Pro/2, Seedream, Midjourney V8.1/Niji 7, Seedance, Happyhorse, and more) through MeiGen's hosted API.
