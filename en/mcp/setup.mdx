...
description: "Install the MeiGen MCP server for Claude Code, Cursor, VS Code, Windsurf, Codex CLI, Hermes Agent, or OpenClaw. Generate with GPT Image 2, Seedance 2.5, and other live MeiGen models."
---
