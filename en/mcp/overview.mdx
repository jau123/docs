...
<CardGroup cols={3}>
  ...
  <Card title="OpenAI-Compatible" icon="plug">
    **Third-party APIs**. Works with OpenAI (gpt-image-1.5, DALL-E 3), Together AI, Fireworks AI, and any OpenAI-compatible endpoint.
  </Card>
</CardGroup>
...
| OpenAI-Compatible | Third-party API | Varies by service | OpenAI models, existing API keys |

**Provider priority**: When multiple providers are configured, MeiGen selects in this order: MeiGen Cloud → ComfyUI → OpenAI. You can override this per-request.
