...
description: "Generate AI images and videos in Claude Code, Cursor, Codex, Windsurf, Hermes Agent, and OpenClaw — MeiGen's open-source MCP server. Supports GPT Image 2, Nano Banana 2, Nanobanana Pro, Midjourney V8.1, Seedream, Grok Imagine, Grok Video 1.5, Flux 2, Z Image Turbo, Seedance, Veo 3.1, Agnes, and local ComfyUI."
---
...
<Note>
  ...
  `generate_video` requires an explicit `model` — there's no platform default. Its `referenceVideoDuration` parameter is deprecated and ignored; upload a reference video and the duration is detected automatically.
</Note>
