...
"og:title": "Generate AI images and videos right inside Claude Code, Cursor and more"
"og:description": "MeiGen MCP server: GPT Image 2, Nano Banana 2, Midjourney, Veo, Seedance plus local ComfyUI — all from your IDE chat. Open source."
"twitter:title": "Generate AI images and videos right inside Claude Code, Cursor and more"
"twitter:description": "MeiGen MCP server: GPT Image 2, Nano Banana 2, Midjourney, Veo, Seedance plus local ComfyUI — all from your IDE chat. Open source."
---
...
<CardGroup cols={3}>
  <Card title="MeiGen Cloud" icon="cloud">
    **Hosted multi-model API**. 9 image and video models: GPT Image 2, Nanobanana Pro/2, Seedream 5.0, Midjourney V8.1, Flux 2 Klein, Seedance 2.0, Happyhorse 1.0, Veo 3.1. No GPU required — just an API key.
  </Card>
