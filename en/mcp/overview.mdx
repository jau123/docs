...
description: "Generate AI images and videos in Claude Code, Cursor, Codex, Windsurf, Hermes Agent, and OpenClaw with MeiGen's open-source MCP server. Supports live MeiGen models, including Seedance 2.5, plus local ComfyUI."
---
