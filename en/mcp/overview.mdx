...
<CardGroup cols={3}>
  <Card title="MeiGen Cloud" icon="cloud">
    **Hosted multi-model API**. Access GPT Image 2, Nanobanana Pro/2, Seedream, Midjourney V8.1/Niji 7, Seedance, Happyhorse, and more. No GPU required — just an API key.
  </Card>
