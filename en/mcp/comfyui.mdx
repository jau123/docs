...
description: "Run AI image generation locally with ComfyUI + MeiGen MCP — free, private, unlimited. Works in Claude Code, Cursor, Codex, Windsurf, Hermes Agent, OpenClaw, and any MCP-compatible host."
---
