---
title: "MCP 插件安装"
description: "为 Claude Code、Cursor、Windsurf 或 OpenClaw 安装 MeiGen MCP 插件，分钟级配置。支持 GPT Image 2、Nano Banana 2、Midjourney、Seedream 等模型。插件开源免费，生成消耗积分。"
---
...
最简单的入门方式。通过 MeiGen 的托管 API 访问多个 AI 模型（GPT Image 2、Nanobanana Pro、Nanobanana 2、Seedream、Midjourney V8.1/Niji 7、Seedance、Happyhorse 等）。
