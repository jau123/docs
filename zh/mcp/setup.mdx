---
title: "MCP 插件安装"
description: "为 Claude Code、Cursor、VS Code、Windsurf、Codex CLI、Hermes Agent 或 OpenClaw 安装 MeiGen MCP,分钟级配置。支持 GPT Image 2、Midjourney V8.1、Seedance 2.0、Veo 3.1 等图像与视频模型。开源,生成消耗积分。"
---
