...
<ParamField body="modelId" type="string">
  ...
  图片模型：`gpt-image-2`, `gemini-3-pro-image-preview`, `nanobanana-2`, `seedream-5.0-lite`, `seedream-4.5`, `midjourney-v7`, `midjourney-niji7`, `z-image-turbo`
...
<ParamField body="resolution" type="string">
  ...
  可选值取决于模型：图片模型支持 `1K` / `2K` / `3K` / `4K`；视频模型支持 `480p` / `720p`。各模型实际支持的分辨率和默认值详见[模型对比](/zh/features/models)。
</ParamField>
