...
<ParamField body="modelId" type="string">
  ...
  图片模型：`gpt-image-2`, `gemini-3-pro-image-preview`, `nanobanana-2`, `seedream-5.0-lite`, `seedream-4.5`, `midjourney-v8.1`, `flux2-klein`, `z-image-turbo`
...
<ParamField body="referenceVideo" type="string">
  ...
  传该字段时计费走"有参考视频"档（Fast 480p 8、720p 14 积分/秒；Pro 720p 16、1080p 28 积分/秒），并应用最低计费秒数（详见[模型](/zh/features/models)）。
</ParamField>
