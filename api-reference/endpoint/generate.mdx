...
<ParamField body="prompt" type="string" required>
  The text description of the image to generate. Length limits vary by model (see [Models](/features/models)).
</ParamField>

<ParamField body="modelId" type="string" default="gemini-3-pro-image-preview">
  The model to use for generation. Get available models from the [List Models](/api-reference/endpoint/models) endpoint.
