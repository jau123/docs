...
Each generation consumes credits based on the model used. Check the [Models](/features/models) page for per-model pricing.
...
<CardGroup cols={2}>
  <Card title="Generate Image" icon="wand-magic-sparkles" href="/api-reference/endpoint/generate">
    POST /api/generate/v2
  </Card>
  <Card title="List Models" icon="robot" href="/api-reference/endpoint/models">
    GET /api/models
  </Card>
  <Card title="Get Image" icon="image" href="/api-reference/endpoint/images">
    GET /api/images/:id
  </Card>
  <Card title="Manage Tokens" icon="key" href="/api-reference/endpoint/tokens">
